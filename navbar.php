...
<img src="images/navigation.JPG" class="img-fluid" alt="captain_Logo" style="width:90px;">
</a>
</div>
...
<li class="nav-item">
<a class="nav-link" href="products.php?filter"><font color=#ff5050><strong>Motorbikes</strong></font></a>
</li>
<li class="nav-item">
<a class="nav-link" href="contact.php?filter"><font color=#ff5050><strong>Showrooms</strong></font></a>
</li>
<?php
$count = counter();
...
if($_SESSION['logged']==false){
    ...
    if($_SESSION['user_type']!='Visitor'){
		...
		echo '<li class="nav-item"><a class="nav-link" href="sales.php?filter"><font color=#ff5050><strong>Sales<span class="badge badge-light">'.$count.
		'</span></strong></font></a>
		 </li>';
		 
		echo '<li class="nav-item"><a class="nav-link" href="reports.php?filter"><font color=#ff5050><strong>Reports</strong></font></a>
		</li>';
...
function counter(){
    $count = 0;
    $db = mysqli_connect('localhost','root','','captainshowroom');
if($_SESSION['logged']){
